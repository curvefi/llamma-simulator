...
URI_TEMPLATE = 'https://app.geckoterminal.com/api/p1/candlesticks/163040533/2150593?resolution=1&from_timestamp={start}&to_timestamp={end}&for_update=false&count_back=329&currency=usd&is_inverted=false'
data = []
